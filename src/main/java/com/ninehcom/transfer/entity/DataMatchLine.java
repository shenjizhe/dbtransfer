...
-|-|-
id                  |Long      |比赛阵容唯一主键
match_id            |Long      |赛事ID   FK -> data_match.id
home_club_id        |Long      |主队ID   FK -> data_club.id
guest_club_id       |Long      |客队ID   FK -> data_club.id
line_url            |String    |比赛球队阵容图URL
home_line_url       |String    |主队阵容图(半场)
guest_line_url      |String    |客队阵容图(半场)
home_line           |String    |主队阵型
guest_line          |String    | 客队阵型
year                |Integer   |比赛年份
