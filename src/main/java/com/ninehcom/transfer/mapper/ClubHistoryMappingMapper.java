 ...
 */
@Component
public class ClubHistoryMappingMapper extends MapperBase {
    ...
    public Map<Integer, ClubHistoryMapping> selectMapClubHistoryMapping() {
        return sqlSession.selectMap("selectAllClubHistoryMapping", null, "teamHistoryId");
    }
